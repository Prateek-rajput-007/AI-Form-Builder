...
function SideNav() {
    ...
    return (
        <div className='h-screen shadow-md border bg-gray-950 text-gray-100'>
            <div className='p-5'>
                {menuList.map((menu) => (
                    <Link
                        href={menu.path}
                        key={menu.id}
                        className={`flex items-center gap-3 p-4 mb-3 
                        hover:bg-gray-800 hover:text-white rounded-lg
                        cursor-pointer
                        ${path === menu.path ? 'bg-gray-800 text-white' : 'text-gray-400'}
                        `}
                    >
                        <menu.icon />
                        {menu.name}
            ...
            <div className='fixed bottom-7 p-6 w-64'>
                <div className='my-7'>
                    <Progress value={percFileCreated} />
                    <h2 className='text-sm mt-2 text-gray-400'>
                        <strong>{formList.length} </strong>Out of <strong>3</strong> File Created
                    </h2>
